...
formatter = logging.Formatter(
    "(%(threadName)-10s) %(asctime)s - %(name)s - %(levelname)s - %(funcName)s: - %(lineno)d %(message)s")
...
class SurveillanceSystem(object):
    ...
    def __init__(self):
        ...
        # //////////////////////////////////////////////////// Camera Examples ////////////////////////////////////////////////////
        self.cameras.append(Camera.IPCamera("testing/iphoneVideos/peopleTest.m4v", "detect_recognise",
                                            False))  # Video Example - uncomment and run code
    ...
    def process_frame(self, camera):
        ...
        while not stop:
            ...
            if frame is None or np.array_equal(frame,
    ...
    def check_camera_events(self, alert):
        ...
        if alert.camera != 'All':  # Check cameras   
            ...
            if alert.event == 'Recognition':  # Check events
                ...
                for person in list(self.cameras[int(alert.camera)].people.values()):
                    logger.info(
